...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-9PHX53LGSP"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-9PHX53LGSP');
</script>
...
* **[People in Public - 250k - stabilized](pip_250k_stabilized/README.md).**  This dataset contains 314,649 background stabilized videos clips of 66 classes of activities performed by people in public places.  
