...
class API(User):
    ...
    def new_collection(self, name, program_name, project_name, collection_description, activities, activity_short_names, objects, actor, creator_cognito_username, consent_overlay_text='Please select the record button, say "I consent to this video collection”'):
