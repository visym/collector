...
pip_to_shortlabel = {'car_drops_off_person': 'drops off person',
                     ...
                     'person_closes_car_door': 'closes',
                     'person_closes_car_trunk': 'closes',
                     'person_closes_facility_door': 'closes',
                     'person_closes_motorcycle_trunk': 'closes trunk',
                     'person_comes_into_scene_through_structure': 'enters',
                     'person_embraces_person': 'hugs',
                     'person_enters_car': 'enters',
                     'person_enters_motorcycle': 'enters',
                     'person_enters_scene_through_structure': 'enters',
                     'person_exits_car': 'exits',
                     'person_exits_motorcycle': 'exits',
                     'person_exits_scene_through_structure': 'exits',
                     'person_holds_hand': 'hold hands',
                     'person_interacts_with_laptop': 'uses laptop',
                     'person_leaves_scene_through_structure': 'exits',
                     'person_loads_car': 'loads',
                     'person_loads_motorcycle': 'loads',
                     'person_opens_car_door': 'opens',
                     'person_opens_car_trunk': 'opens trunk',
                     'person_opens_facility_door': 'opens',
                     ...
                     'person_talks_on_phone': 'talks on',
                     'person_talks_to_person': 'talks to',
                     'person_texts_on_phone': 'texts on',
